#!/usr/bin/python
""" Test/Verify BGP ECMP Load Balancing """
...
DOCUMENTATION = """
---
module: test_bgp_ecmp_loadbalancing
...
EXAMPLES = """
- name: Verify bgp ecmp loadbalancing paths
  test_bgp_ecmp_loadbalancing:
...
def verify_bgp_ecmp_load_balancing(module):
    """
    Method to verify bgp ecmp load balancing paths.
    :param module: The Ansible module to fetch input parameters.
    """
